...
namespace Learnova2023.API.Controllers
{
    ...
    public class StudenteController : ControllerBase
    {
        ...
        [HttpGet(nameof(GetStudenteByUsername))]
        public Studente GetStudenteByUsername(string username, string sk)
        {
            return ContextStudenti.GetStudenteByUsername(username, sk);
        }
