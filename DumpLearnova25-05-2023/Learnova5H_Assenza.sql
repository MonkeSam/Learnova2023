...
CREATE TABLE `Assenza` (
  ...
  PRIMARY KEY (`Studente`,`Data`),
  CONSTRAINT `Assenza_Studente` FOREIGN KEY (`Studente`) REFERENCES `Studente` (`Id`) ON DELETE CASCADE
...
INSERT INTO `Assenza` VALUES (8,'2023-11-23 08:37:00');
