...
CREATE TABLE `Assegnazione` (
  ...
  `Classe` int NOT NULL,
  PRIMARY KEY (`Professore`,`Classe`),
  KEY `Assegnazione_Classe_idx` (`Classe`),
  CONSTRAINT `Assegnazione_Classe` FOREIGN KEY (`Classe`) REFERENCES `Classe` (`Id`),
  CONSTRAINT `Assegnazione_Professore` FOREIGN KEY (`Professore`) REFERENCES `Professore` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `Assegnazione` VALUES (1,1);
