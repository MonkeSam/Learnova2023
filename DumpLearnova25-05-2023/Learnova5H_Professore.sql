...
CREATE TABLE `Professore` (
  ...
  CONSTRAINT `Professore_Utente` FOREIGN KEY (`Utente`) REFERENCES `Utente` (`User`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `Professore` VALUES (1,'Maurizio','Sintuzzi',1500,'Cizio');
